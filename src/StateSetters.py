...
class ProbabilisticStateSetter(StateSetter):
    ...
    def __init__(self, verbose: int = 0, training: bool = True):
        self.old_state = None
...
kickoff_prob = 0.15
airDribble2Touch_prob = 0.05
scoredReplay_prob = 0.2
shotState_prob = 0.13
jumpShotState_prob = 0.15
...
all_probs = [kickoff_prob, airDribble2Touch_prob, shotState_prob, jumpShotState_prob, airdribbleSetup_prob, SideHighRoll_prob,saveState_prob]

states = [DefaultState(), AirDribble2Touch(), ShotState(), JumpShotState(), AirDribbleSetup(), SideHighRoll(), SaveState()]
