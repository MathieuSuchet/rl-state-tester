...
from callbacks import Callback, MultiCallback
...
class StandaloneRunner(Callback, ABC):
    ...
    def run_standalone(self, target_steps):
        ...
        while self._n_steps < target_steps:
            ...
            self.on_step(obs, reward, terminated, info)
...
class MultiStandaloneRunner(MultiCallback):
    def __init__(self, env: Gym, agent: PPO, rendered: bool, deterministic: bool, callbacks: List[Callback]):
